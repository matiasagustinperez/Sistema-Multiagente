...
\node[lbl, gray] at (5, -1.55) {\footnotesize el usuario aporta la URL; el sistema valida};

% flecha izquierda→derecha (create-gdoc)
\draw[fgd]
  ([yshift=-6pt]BD0.east) -- ([yshift=-6pt]GD0.west)
  node[lbl, midway, below=3pt] {\texttt{create-gdoc}};
\node[lbl, gray] at (5, -2.4) {\footnotesize genera DOCX en BD, sube a Drive, retorna enlace};
