...
CREATE TABLE teachers (
	...
	category VARCHAR, 
	created_at DATETIME DEFAULT CURRENT_TIMESTAMP, dedication VARCHAR(50), normalized_key TEXT, updated_at DATETIME, password_hash VARCHAR(255), last_login DATETIME, is_admin BOOLEAN DEFAULT 0 NOT NULL, dni TEXT, password_reset_at DATETIME, 
	PRIMARY KEY (id)
);
