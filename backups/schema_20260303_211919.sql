...
CREATE INDEX ix_careers_id ON careers (id)
...
CREATE INDEX ix_evaluative_instrument_folders_career ON evaluative_instrument_folders (career)

CREATE INDEX ix_evaluative_instrument_folders_created_at ON evaluative_instrument_folders (created_at)

CREATE INDEX ix_evaluative_instrument_folders_gdrive_folder_id ON evaluative_instrument_folders (gdrive_folder_id)

CREATE INDEX ix_evaluative_instrument_folders_id ON evaluative_instrument_folders (id)

CREATE INDEX ix_evaluative_instrument_folders_study_plan ON evaluative_instrument_folders (study_plan)

CREATE INDEX ix_evaluative_instrument_folders_subject ON evaluative_instrument_folders (subject)

CREATE INDEX ix_evaluative_instruments_career ON evaluative_instruments (career)

CREATE INDEX ix_evaluative_instruments_created_at ON evaluative_instruments (created_at)

CREATE INDEX ix_evaluative_instruments_gdrive_file_id ON evaluative_instruments (gdrive_file_id)

CREATE INDEX ix_evaluative_instruments_id ON evaluative_instruments (id)

CREATE INDEX ix_evaluative_instruments_instrument_type ON evaluative_instruments (instrument_type)

CREATE INDEX ix_evaluative_instruments_study_plan ON evaluative_instruments (study_plan)

CREATE INDEX ix_evaluative_instruments_subject ON evaluative_instruments (subject)
...
CREATE TABLE careers (
	...
	created_at DATETIME DEFAULT CURRENT_TIMESTAMP, director_id INTEGER, secretario_id INTEGER, 
	PRIMARY KEY (id)
)
...
CREATE TABLE evaluative_instrument_folders (
	id INTEGER NOT NULL, 
	career VARCHAR(255) NOT NULL, 
	study_plan VARCHAR(255), 
	subject VARCHAR(255) NOT NULL, 
	gdrive_folder_url VARCHAR(1000), 
...
CREATE TABLE evaluative_instruments (
	id INTEGER NOT NULL, 
	career VARCHAR(255) NOT NULL, 
	study_plan VARCHAR(255), 
	subject VARCHAR(255) NOT NULL, 
...
CREATE TABLE teachers (
	...
	category VARCHAR, 
	created_at DATETIME DEFAULT CURRENT_TIMESTAMP, dedication VARCHAR(50), normalized_key TEXT, updated_at DATETIME, password_hash VARCHAR(255), last_login DATETIME, is_admin BOOLEAN DEFAULT 0 NOT NULL, dni TEXT, password_reset_at DATETIME, gmail_refresh_token TEXT, 
	PRIMARY KEY (id)
)